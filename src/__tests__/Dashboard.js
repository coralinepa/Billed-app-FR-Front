...
//Cette ligne remplace le module store par un mock (mockStore), permettant de contrôler les données retournées par l'API simulée.
jest.mock("../app/store", () => mockStore);

//Scénarios de Tests
//Les tests sont organisés en plusieurs suites de tests décrites par des describe et des test ou it (interchangeables avec test), qui décrivent les scénarios de test spécifiques.

//Tests des Filtrages de Factures
//Ces tests vérifient la fonctionnalité filteredBills pour différents statuts de factures (en attente, accepté, refusé).
describe("Given I am connected as an Admin", () => {
  ...
  //Ces tests vérifient l'affichage du tableau de bord dans différentes conditions (chargement, erreur).
  ...
  //Ces tests simulent des interactions utilisateur sur la page du tableau de bord, comme cliquer sur des icônes de flèches pour afficher des tickets, cliquer sur des icônes d'édition, et vérifier que les formulaires sont correctement remplis ou que des icônes spécifiques apparaissent.
...
//Ces tests vérifient que les factures sont correctement récupérées depuis l'API mockée et gèrent les erreurs de l'API.
